    ...
    <div className="gradient-bg">
      <div className="gradient-container">
        ...
        <div className="g4"></div>
          ...
          <div className="lpuInviteWrapper">
            <div className="lpuInviteContainer">
              <h3>
                Invite a <span>Friend</span>
              </h3>
              <p>
                Having fun with CODEREALM? Share the love with a friend (or
                two)! Enter their email, and we'll send them a personal invite
                to join the community.
              </p>
              <div className="lpuInviteInput">
                <input
                  type="email"
